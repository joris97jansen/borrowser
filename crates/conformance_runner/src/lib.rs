...
pub use aggregate::{
    ...
    AGGREGATE_SUMMARY_MAX_BYTES_V1, AdvisoryAttachmentComparison, AdvisoryComparisonFailure,
    AdvisoryDifferenceLine, AdvisoryFirstDifference, AdvisoryTrackId, AdvisoryVerdict,
    AggregateAccounting, AggregateCaseResult, AggregateComparisonKind,
    AggregateEnvironmentAssessmentMode, AggregateExecutionAttempt, AggregateExecutionRequest,
    AggregateExecutionVariantId, AggregateGroupingAccounting, AggregateIdentityError,
    AggregateLogicalCaseMemberDigest, AggregateLogicalCaseSourceSetDigest,
    ...
    AggregateVariantResult, BASELINE_FORMAT_V1, BASELINE_MAX_BYTES_V1, BaselineError,
    BaselineFileInputV1, BaselineNoteId, BaselineSealError, CAPTURE_ALGORITHM_PATH_V1,
    CAPTURE_CONFIGURATION_PATH_V1, CaptureSourceError, ComparableObservationSurface,
    ConformanceTrendV1, DomObservationFailure, ExternalRegistryAttachmentSubjectKey,
    ExternalRegistryDiagnostic, ExternalRegistryDiagnosticComponent,
    ExternalRegistryDiagnosticDetail, ExternalRegistryDiagnosticField,
    ExternalRegistryDiagnosticKind, ExternalRegistryDiagnosticSubjectKey,
    ExternalRegistryRecordCollection, ExternalRegistryTrackInvariantField,
    ExternalRegistryValidationPhase, LaneSelection, LogicalHeadlineCounts,
    MAX_ADVISORY_DIFFERENCE_BYTES_V1, MAX_ADVISORY_DIFFERENCE_POOL_BYTES_V1,
    MAX_ADVISORY_EXCERPT_BYTES_V1, MAX_CAPTURE_SOURCE_BYTES_V1, PopulationTrend,
    ReconciledBaselineNote, ReconciledExternalAdvisoryEvidence, ReconciledExternalAttachment,
    SealedBaselineEvidence, SelectedDomAdvisoryOperation, SelectedDomOperationError,
    SelectedDomOperationRequest, SelectedDomOperationRun, SelectedDomOperationScope,
    StoredValidatedCapture, TREND_FORMAT_V1, TREND_MAX_BYTES_V1, TREND_VERSIONS_V1,
    TerminalOutcomeCounts, TrendChangeKind, TrendCompatibilityField, TrendError, TrendInputSide,
    TrendPopulation, TrendPopulationCounts, TrendRecord, ValidatedAdvisoryTrack,
    VerifiedCaptureSourcesV1, build_aggregate_detail_v1, build_aggregate_summary_v1,
    build_and_write_aggregate_detail_v1, build_and_write_aggregate_summary_v1,
    build_and_write_baseline_v1, build_and_write_trend_v1, build_baseline_v1, build_trend_v1,
    ...
    run_repository_aggregate_for_selected_dom_operation, seal_baseline_from_selected_operation,
