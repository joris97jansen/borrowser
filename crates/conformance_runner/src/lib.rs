...
pub use aggregate::{
    ...
    AggregateVariantResult, BaselineNoteId, CAPTURE_ALGORITHM_PATH_V1,
    CAPTURE_CONFIGURATION_PATH_V1, CaptureSourceError, ComparableObservationSurface,
    DomObservationFailure, ExternalRegistryAttachmentSubjectKey, ExternalRegistryDiagnostic,
    ...
    ExternalRegistryTrackInvariantField, ExternalRegistryValidationPhase, LaneSelection,
    LogicalHeadlineCounts, MAX_ADVISORY_DIFFERENCE_BYTES_V1, MAX_ADVISORY_DIFFERENCE_POOL_BYTES_V1,
    MAX_ADVISORY_EXCERPT_BYTES_V1, MAX_CAPTURE_SOURCE_BYTES_V1, ReconciledBaselineNote,
    ReconciledExternalAdvisoryEvidence, ReconciledExternalAttachment, SelectedDomAdvisoryOperation,
    SelectedDomOperationError, SelectedDomOperationRequest, SelectedDomOperationRun,
    SelectedDomOperationScope, StoredValidatedCapture, TerminalOutcomeCounts,
    ValidatedAdvisoryTrack, VerifiedCaptureSourcesV1, build_aggregate_detail_v1,
    build_aggregate_summary_v1, build_and_write_aggregate_detail_v1,
    build_and_write_aggregate_summary_v1, load_repository_external_advisory_evidence,
    run_repository_aggregate, run_repository_aggregate_for_selected_dom_operation,
};
