...
use conformance_test_support::{
    ...
    ExecutionEnvironmentAssessment, ExpectationView, ExpectedResultView, HarnessReadinessView,
    InventoryRepository, ObservationSurface, StabilityView, TestId, UnresolvedPrerequisite,
...
struct MetadataFacts {
    classification: ClassificationCompleteness,
    requirements: Vec<conformance_test_support::RequirementTag>,
    capability: Option<CapabilityAvailability>,
    harness: Option<HarnessReadiness>,
    environment_requirements: Vec<ReasonedEnvironmentRequirement>,
    stability: Option<Stability>,
    lane_exclusions: Vec<ReasonedLaneExclusion>,
}

fn metadata_facts(view: ExpectedResultView<'_>) -> MetadataFacts {
...
fn ag_expectation(view: ExpectedResultView<'_>) -> AgExpectation {
    match view.classification() {
...
fn eligibility_facts(value: ExecutionEligibility) -> Eligibility {
    match value {
