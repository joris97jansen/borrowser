...
//!   domain IDs (e.g., `html::internal::Id`) to `InputId` at call boundaries
...
/// # Integration Pattern
///
/// For DOM-based systems, convert `html::internal::Id` to `InputId` at the routing boundary:
///
/// ```ignore
/// fn handle_input(html_id: html::internal::Id, store: &mut impl InputStore) {
