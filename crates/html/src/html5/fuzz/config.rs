...
const DEFAULT_MAX_PATCHES_PER_FLUSH: usize = 4 * 1024;
const DEFAULT_MAX_PATCHES_PER_INPUT_BYTE: usize = 16;
...
pub struct Html5PipelineFuzzConfig {
    ...
    pub max_patches_per_flush: usize,
    pub max_patches_per_input_byte: usize,
...
impl Default for Html5PipelineFuzzConfig {
    fn default() -> Self {
        Self {
            ...
            max_patches_per_flush: DEFAULT_MAX_PATCHES_PER_FLUSH,
            max_patches_per_input_byte: DEFAULT_MAX_PATCHES_PER_INPUT_BYTE,
...
pub enum Html5PipelineFuzzTermination {
    ...
    RejectedMaxPatchesPerFlush,
    RejectedMaxPatchDensity,
