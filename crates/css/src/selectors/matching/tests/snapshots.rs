...
fn selector_matching_debug_snapshot_is_stable_for_simple_selector_cases() {
    ...
    assert_matching_debug_snapshot(
        ...
        concat!(
            ...
            "  element[2]: id=3 namespace=html local=\"p\" parent=1 prev-sibling=2\n",
            "matches:\n",
...
fn selector_matching_debug_snapshot_is_stable_for_compound_selector_cases() {
    ...
    assert_matching_debug_snapshot(
        ...
        concat!(
            ...
            "  element[0]: id=1 namespace=html local=\"body\" parent=none prev-sibling=none\n",
            "  element[1]: id=2 namespace=html local=\"div\" parent=1 prev-sibling=none\n",
            "  element[2]: id=3 namespace=html local=\"div\" parent=1 prev-sibling=2\n",
...
fn selector_matching_debug_snapshot_is_stable_for_complex_selector_cases() {
    ...
    assert_matching_debug_snapshot(
        ...
        concat!(
            ...
            "  elements: 3\n",
            "  element[0]: id=1 namespace=html local=\"body\" parent=none prev-sibling=none\n",
            "  element[1]: id=2 namespace=html local=\"main\" parent=1 prev-sibling=none\n",
            "  element[2]: id=3 namespace=html local=\"p\" parent=2 prev-sibling=none\n",
            "matches:\n",
            "  target[0]: element=1 name=\"body\"\n",
            "    matchability: parsed\n",
            "    matched: no\n",
...
fn selector_matching_debug_snapshot_is_stable_for_invalid_selector_cases() {
    ...
    assert_matching_debug_snapshot(
        ...
        concat!(
            ...
            "dom:\n",
            "  elements: 1\n",
            "  element[0]: id=1 namespace=html local=\"div\" parent=none prev-sibling=none\n",
            "matches:\n",
...
fn selector_matching_debug_snapshot_reports_limit_errors_explicitly() {
    ...
    assert_matching_debug_snapshot_with_limits(
        ...
        concat!(
            ...
            "  elements: 2\n",
            "  element[0]: id=1 namespace=html local=\"body\" parent=none prev-sibling=none\n",
            "  element[1]: id=2 namespace=html local=\"span\" parent=1 prev-sibling=none\n",
            "matches:\n",
            "  target[0]: element=1 name=\"body\"\n",
            "    matchability: parsed\n",
            "    matched: no\n",
