    ...
    pub fn build(self) -> Result<ComputedStyle, ComputedStyleBuildError> {
        ...
        Ok(ComputedStyle {
            ...
            box_metrics: BoxMetrics {
                ...
                border_top: border_edges.top.computed_width_contribution(),
                border_right: border_edges.right.computed_width_contribution(),
                border_bottom: border_edges.bottom.computed_width_contribution(),
                border_left: border_edges.left.computed_width_contribution(),
            },
            border_edges,
            outline: Outline {
