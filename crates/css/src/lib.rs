...
pub use cascade::{
    ...
    LegacyStyleAttachmentError, MatchedStylesheetRuleInput, RULE_COLLECTION_DIAGNOSTIC_VERSION,
    RawRuleIndex, ResolvedDocumentStyle, ResolvedElementStyle, ResolvedStyle, ResolvedStyleEntry,
